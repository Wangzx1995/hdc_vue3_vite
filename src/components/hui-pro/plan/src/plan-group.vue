    ...
    >
        ...
        >
            <div class="h-plan-group__panel">
                <template v-for="(item, index) in interval" :key="index">
                    <div class="h-plan-group__tickline"></div>
                </template>
            </div>
        </div>
        <!-- 时间轴 -->
        <div :style="timelineStyle" class="h-plan-group__timeline-wrap">
            ...
            <ul class="h-plan-group__timeline">
                <template v-for="(item, index) in interval" :key="index">
                    <li v-if="index % 2 === 0" class="h-plan-group__scale">
